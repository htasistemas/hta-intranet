...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaHTMLAttributes<HTMLTextAreaElement>>(function Textarea({ className, ...props }, ref) {
  return <textarea ref={ref} className={cn("min-h-24 w-full rounded-xl border border-slate-700 bg-sidebar p-3 text-sm text-foreground outline-none focus:border-accent", className)} {...props} />;
});
