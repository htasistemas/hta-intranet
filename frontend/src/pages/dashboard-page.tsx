...
import { CalendarCheck, Cake, CircleDollarSign, Contact, ContactRound, ListTodo, Network, Target, UserCheck, UserX } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const cards = [
    ...
    ["Parceiros ativos", data.kpis.activePartners, Network, "Parcerias disponiveis"],
